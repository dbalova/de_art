                    ...
                    child: Column(
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.only(top: 24.0),
                          child: Conveniences(
                              context, 'assets/IconTV.svg', "Плазменные телевизоры со спутниковыми телеканалами"),
                        ),
                        Padding(
                          padding: const EdgeInsets.only(top: 24.0),
                          child: Conveniences(
                              context, 'assets/IconBathMassage.svg', "Гидромассажная ванная, расположенная в номере"),
                        ),
                        Padding(
                          padding: const EdgeInsets.only(top: 24.0),
                          child: Conveniences(
                        ...
                        Padding(
                          padding: const EdgeInsets.only(top: 24.0),
                          child: Conveniences(
                              context, 'assets/IconReceptionHelp.svg', "Удобства и услуги"),
                        ),
                        const Padding(
                          padding: EdgeInsets.only(top: 10, bottom: 24),
                          child: Align(
                        ...
                        Padding(
                          padding: const EdgeInsets.only(top: 24.0),
                          child: Conveniences(context, 'assets/IconTelevision.svg',
                              "Спутниковое ТВ"),
                        ),
                        Padding(
                          padding: const EdgeInsets.only(top: 24.0),
                        ...
                        Padding(
                          padding: const EdgeInsets.only(top: 24.0),
                          child: Conveniences(context, 'assets/IconCleaning.svg',
                              "Ежедневная уборка"),
                        ),
                        Padding(
                          padding: const EdgeInsets.only(top: 24.0),
                          child: Conveniences(context, 'assets/IconBathrobe.svg',
                              "Халаты, тапочки"),
                        ),
                        Padding(
                          padding: const EdgeInsets.only(top: 24.0),
